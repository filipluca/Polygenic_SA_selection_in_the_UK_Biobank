...
#SBATCH --job-name=bolt_gwas_m_f_perm2_bgen_chrALL
...
--phenoFile=pheno_filtered_v3_perm2_for_boltlmm.txt \
--phenoCol=SexPerm2.numeric \
--covarFile=pheno_filtered_v3_perm2_for_boltlmm.txt \
--covarCol=f.54.0.0 \
--covarMaxLevels=22 \
...
--statsFileBgenSnps=stats_gwas_mf_perm2_imputed_chr${SLURM_ARRAY_TASK_ID}.tab
