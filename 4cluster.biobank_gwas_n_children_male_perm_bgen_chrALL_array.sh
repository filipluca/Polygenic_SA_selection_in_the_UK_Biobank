...
#SBATCH --job-name=bolt_gwas_nchilren_male_perm_bgen_chrALL
...
--statsFile=stats_gwas_nchildren_male_perm_genotyped_autosomes_when_running_imputed_chr${SLURM_ARRAY_TASK_ID}.tab \
--numThreads=8 \
...
--statsFileBgenSnps=stats_gwas_nchildren_male_perm_imputed_chr${SLURM_ARRAY_TASK_ID}.tab
