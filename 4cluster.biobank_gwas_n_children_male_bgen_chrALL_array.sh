...
#SBATCH --job-name=bolt_gwas_nchilren_male_bgen_chrALL
...
--phenoFile=pheno_filtered_v3_for_boltlmm_nchildren.txt \
--phenoCol=Number_of_children \
--remove=list_of_female_ids_v3.txt \
...
--statsFile=stats_gwas_nchildren_male_genotyped_autosomes_when_running_imputed_chr${SLURM_ARRAY_TASK_ID}.tab \
--numThreads=8 \
...
--statsFileBgenSnps=stats_gwas_nchildren_male_imputed_chr${SLURM_ARRAY_TASK_ID}.tab
